...
"""Cкрипты для добавления данных в модель"""

#for dictionary in specialties:
#   Specialty.objects.create(code=dictionary['code'],title=dictionary['title'])

#from company_app.models import Company

# for dictionary in companies:
#     new_company = Company(
#        id=dictionary['id'], name=dictionary['name'], logo=f"/static/company/img/{dictionary['logo']}",
#        employee_count=dictionary['employee_count'], location=dictionary['location'],
#        description=dictionary['description'],
#     )
#    new_company.save()

#for dictionary in jobs:
#    Vacancy.objects.create(
#        title=dictionary['title'], specialty=Specialty.objects.get(code=dictionary['specialty']),
#        company=Company.objects.get(id=dictionary['company']), salary_from=dictionary['salary_from'],
#        salary_to=dictionary['salary_to'], posted=dictionary['posted'],
#        skills=dictionary['skills'], description=dictionary['description'],
#    )
